...
exports.isObj = function (obj) { return typeof obj === 'object' && obj !== null && obj.constructor === Object; };
exports.isFn = function (arg) { return typeof arg === 'function'; };
exports.isFnObj = function (obj) {
    if (exports.isObj(obj)) {
        return Object.keys(obj).every(function (key) { return exports.isFn(obj[key]); });
    }
    return false;
};
...
exports.isPromise = function (obj) { return obj && typeof obj.then === 'function'; };
// export const isVoid = <T>(ar: T | void): ar is void => !ar;
exports.isStoreModule = function (obj) {
    if (!exports.isObj(obj) || !exports.isFnObj(obj.actions)) {
        return false;
    }
